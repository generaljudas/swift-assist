          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 p-6 sm:p-10">
            ...
            <div>
              ...
              <div className="prose max-w-none text-gray-600 space-y-4">
                ...
                <p>
                  Our platform enables businesses of all sizes to provide instant, 24/7 support to
                  their customers, reducing wait times and increasing satisfaction.
                </p>
                <p>
                  We believe in the power of AI to transform customer service, but we also know that
                  the human touch is irreplaceable. That's why our solutions are designed to
                  complement human agents, not replace them.
                </p>
              </div>
              ...
              <div className="mt-8">
                ...
                <ul className="space-y-2 text-gray-600">
                  <li className="flex items-start">
                    ...
                    <span>
                      <strong>Customer First:</strong> We prioritize customer needs in everything we
                      build.
                    </span>
                  </li>
                  <li className="flex items-start">
                    ...
                    <span>
                      <strong>Innovation:</strong> We continuously explore new technologies to
                  ...
                  <li className="flex items-start">
                    ...
                    <span>
                      <strong>Transparency:</strong> We believe in open communication with our
                      customers.
                    </span>
                  </li>
                  <li className="flex items-start">
                    ...
                    <span>
                      <strong>Security:</strong> We prioritize data security and privacy in all our
                      operations.
                    </span>
                  </li>
                </ul>
                ...
                <div className="bg-gray-50 p-6 rounded-lg border border-gray-200 hover:border-blue-500 transition-colors duration-300">
                  <div className="flex items-start">
                    ...
                    <div className="ml-4">
                      ...
                      <a
                        href="mailto:support@swiftassist.com"
                        className="mt-2 inline-block text-blue-600 font-medium hover:text-blue-800"
                      >
