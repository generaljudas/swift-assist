...
const ChatInput = ({ inputMessage, setInputMessage, isLoading, handleSendMessage, inputRef }) => (
      ...
      setMessages([
        {
          role: 'assistant',
          content:
            'Welcome, admin! Please set up your API key in the settings to enable the chat functionality.',
        },
      ]);
    }
