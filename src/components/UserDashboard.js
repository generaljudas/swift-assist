              ...
              <div>
                ...
                <div className="flex items-center">
                  <input
                    ...
                    aria-label="Enable message sounds"
                  />
            ...
            <div className="space-y-6">
              <div className="bg-blue-50 p-4 rounded-lg border border-blue-200">
                ...
                <p className="text-blue-700">
                  Welcome to our customizable chat! This guide will help you make the most of our
                  chat features.
                </p>
              </div>
              ...
              <div className="space-y-4">
                ...
                <div className="pl-4 border-l-2 border-gray-200">
                  <p className="mb-2">
                    The Chat Context feature allows you to customize how the AI responds to your
                    queries:
                  </p>
                  <ol className="list-decimal list-inside space-y-2 text-gray-700">
                    <li>
                      Navigate to the <strong>Chat Context</strong> tab
                    </li>
                    <li>
                      Enter specific information about your business, preferences, or requirements
                    </li>
                    <li>
                      Click <strong>Save Context</strong> to apply your changes
                    </li>
              ...
              <div className="space-y-4">
                ...
                <div className="pl-4 border-l-2 border-gray-200">
                  ...
                  <ul className="list-disc list-inside space-y-2 text-gray-700">
                    <li>
                      Check your current token balance in the <strong>Add Tokens</strong> tab
                    </li>
              ...
              <div className="space-y-4">
                ...
                <div className="pl-4 border-l-2 border-gray-200">
                  <p className="mb-2">
                    Personalize your chat interface in the <strong>Customize Chat</strong> tab:
                  </p>
                  <ul className="list-disc list-inside space-y-2 text-gray-700">
                    ...
                    <li>
                      Click <strong>Save Preferences</strong> to apply your changes
                    </li>
                  </ul>
                </div>
              </div>
          ...
          <div className="p-6">
            ...
            <div className="space-y-6">
              <div className="bg-blue-50 p-4 rounded-lg border border-blue-200">
                ...
                <p className="text-blue-700">
                  Create a personalized link to share your customized chat with others. They'll be
                  able to interact with the AI using your predefined context and settings.
                </p>
              </div>
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <p className="mt-1 text-sm text-gray-500">
                      Use only letters, numbers, hyphens, and underscores (e.g., company-support,
                      product_demo)
                    </p>
                  </div>
                  ...
                  <div className="flex items-center space-x-2">
                    <input
                      type="checkbox"
                      className="h-4 w-4 text-blue-500 focus:ring-blue-500 border-gray-300 rounded"
                      aria-label="Use current context settings"
                    />
                  ...
                  <div className="flex items-center space-x-2">
                    <input
                      type="checkbox"
                      className="h-4 w-4 text-blue-500 focus:ring-blue-500 border-gray-300 rounded"
                      aria-label="Use current theme settings"
                    />
              ...
              <div className="bg-yellow-50 p-4 rounded-lg border border-yellow-200">
                ...
                <ul className="list-disc list-inside space-y-2 text-yellow-700">
                  ...
                  <li>
                    Choose a memorable but secure custom link name to make it easy for users to
                    access
                  </li>
                </ul>
              </div>
